...
export const CalculadoraSnack = ({sumatoriaTotal, setCalculadoraSnack, actualizarFormulario, setCambioEnCalculadora}) => {
  ...
  return (
    <div className="">
      ...
      <div style={{width: "97%", height: "45%", opacity:"90%", position:"fixed", top: "35%", left: "0%", color:"white"}} className="offcanvas offcanvas-start shadow-lg rounded bg-dark" data-bs-scroll="true" data-bs-backdrop="false" tabIndex="-1" id="snack" aria-labelledby="offcanvasScrollingLabel">
