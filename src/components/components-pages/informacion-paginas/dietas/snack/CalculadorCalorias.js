...
export const CalorieCalculator = ({sumatoriaTotal, setCalculadoraSnack, actualizarFormulario, setCambioEnCalculadora}) => {
  ...
  const setearAlimentos = (dietaValores, n)=>{
    ...
    if(numero === 0 || n === 1){
      ...
      setCalculadoraSnack(suma);
      sumatoriaTotal(dietaActiva.id, suma, dietaActiva, "snack");
