...
export const CalorieCalculator = ({sumatoriaTotal, setCalculadoraCena, actualizarFormulario, setCambioEnCalculadora}) => {
  ...
  const setearAlimentos = (dietaValores, n)=>{
    ...
    if(numero === 0 || n === 1){
      ...
      setCalculadoraCena(suma);
      sumatoriaTotal(dietaActiva.id, suma, dietaActiva, "cena");
