...
export const CalculadoraAlmuerzo = () => {


  return (
    <div className="">
      {/*  translate-middle colocar en className si se quiere centrar, estaba en position absolute top-50 start-0*/}
      <div style={{width: "97%", height: "20%", opacity:"90%", position:"fixed", top: "35%", left: "0%", color:"white"}} className="offcanvas offcanvas-start shadow-lg rounded bg-dark" data-bs-scroll="true" data-bs-backdrop="false" tabIndex="-1" id="almuerzo" aria-labelledby="offcanvasScrollingLabel">
