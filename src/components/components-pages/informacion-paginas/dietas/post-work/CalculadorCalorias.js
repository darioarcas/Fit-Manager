...
export const CalorieCalculator = ({sumatoriaTotal, setCalculadoraPostWork, actualizarFormulario, setCambioEnCalculadora}) => {
  ...
  const setearAlimentos = (dietaValores, n)=>{
    ...
    if(numero === 0 || n === 1){
      ...
      setCalculadoraPostWork(suma);
      sumatoriaTotal(dietaActiva.id, suma, dietaActiva, "post-work");
